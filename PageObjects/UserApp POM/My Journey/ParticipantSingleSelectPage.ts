...
export class ParticipantActivitySingleSelectPageLocate {
    ...
    delhiRadiobuttonBtn:ElementFinder;
    delhisingleSelectCheckedOption: ElementFinder;
    activityContinueBtn:ElementFinder;
    momentaRadioOptonAndDescriptionBtn:ElementFinder;
    momentaText:ElementFinder;
    momentaTextDescription:ElementFinder;
    ...
    constructor() {
        ...
        this.delhiRadiobuttonBtn = element(By.xpath("//label[contains(.,'Delhi')]"));
        this.delhisingleSelectCheckedOption = element(By.xpath("(//div[@class='mat-radio-inner-circle'])[1]/../../.."));
        this.activityContinueBtn = element(By.xpath("//button[@name='Continue to Next Activity']"));
        this.momentaRadioOptonAndDescriptionBtn = element(By.xpath("//label[contains(.,'MomentaMomenta is customized product')]"));
        this.momentaText = element(By.xpath("//span[contains(text(),'Momenta')]"));
        this.momentaTextDescription = element(By.xpath("//p[.='Momenta is customized product']"));
