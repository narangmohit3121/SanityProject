...
export class NewLeaderboardPageLocate {
    ...
    constructor() {
        this.participantNaviationMenu = element(By.xpath("//button[@name='Open the menu']"));
        ...
        this.participantScore = element(By.xpath("//span[contains(text(),'Your Score')]/../following-sibling::div/progress"));
        this.topScore = element(By.xpath("//span[contains(text(),'Top Score')]/../following-sibling::div/span"));
        this.medianScore = element(By.xpath("//span[contains(text(),'Median score')]/../following-sibling::div/progress"));
