...
export class ActivityAuthoringPageLocate {
    ...
    continueWithoutSaving: ElementFinder;


    constructor() {

        this.sampleContent = element(By.xpath("//p[contains(text(),'Test Activity_MN')]/../.."));
        this.activityTitle = element(By.xpath("//textarea[contains(@name,'Activity Title')]"));
        this.activityDescription = element(By.xpath("//textarea[contains(@name,'Description')]"));
       ...
       // this.contentTypeAllOptions = element.all(By.css("div[class*='mat-select-panel'] > div > mat-option"));
        ...
        this.saveDraftBtn = element(By.xpath("//button[contains(text(),'SAVE DRAFT')]"));
        ...
        this.animateInToggleBtn = element(By.xpath("//mat-slide-toggle[contains(@name,'scrollConfiguration')]//label"));
        ...
        this.uploadVideoBtn = element(By.xpath("//button[contains(text(),'Upload Video')]"));
        this.directVideoURL = element(By.xpath("//button[contains(text(),'Upload Video')]/preceding::input[contains(@name,'Direct URL')]"));
        ...
        this.editDoneButton = element(By.xpath("//div[contains(@class,'submit')]//button[not(contains(@class,'create-field')) and contains(text(),'Ok')]"));        
        ...
        this.deleteButtonFirstContent = element(By.xpath("(//mat-expansion-panel-header//button[contains(text(),'Content')]/following-sibling::button[@name = 'delete'])[1]"));
        ...
        this.copyFirstContentBtn = element(By.xpath("(//mat-expansion-panel-header//button[contains(text(),'Content')]/following-sibling::button[@name = 'copy'])"));
       ...
       // this.chooseColor = element(By.xpath("//input[contains(@placeholder,'Choose color')]"));
        ...
        this.columnTextWrappers = element.all(By.css("app-block-editor div.content-wrapper div[class*='fr-element'] p"));
        //this.cancelEditedContentBtn = element(By.name("cancel"));
        this.cancelEditedContentBtn = element(By.xpath("//mat-dialog-container//button[@name='cancel' and not(contains(@class,'close'))]"));
        ...
        this.imageFloatLeftOption = element(By.xpath("//label[contains(text(),'Image Block')]/following-sibling::div//mat-radio-button[contains(@name,'Left')]//label"));
        ...
        this.cardSizeSmall = element(By.xpath("//span[contains(text(),'Small')]/ancestor::label"));
        this.cardAlignmentDD = element(By.xpath("//label[contains(text(),'Card Back')]/following-sibling::select"));
        this.cardAlignmentCenter = element(By.xpath("//span[contains(text(),'Center')]/ancestor::label"));
        ...
        this.cardSizeElement = element(By.xpath("//app-input[contains(@class,'co-cards__headerItem')]/../../.."));
        this.addCardBtn = element(By.name("add-card"));
        this.newCardFrontInput = element(By.xpath("(//label[contains(text(),'Card Front')]//following-sibling::app-input//div[contains(@class,'fr-element')]//p)[last()]"));
        this.newCardBackInput = element(By.xpath("(//label[contains(text(),'Card Back')]//following-sibling::app-input//div[contains(@class,'fr-element')]//p)[last()]"));
        ...
        this.publishBtn = element(By.xpath("//button[contains(text(),'PUBLISH')]"));
        ...
        this.petronasImageCollection = element(By.xpath("//ul//a[contains(text(),'petronas')]"));
        //this.imageList = element.all(By.xpath("//app-image-chooser//div[@class='image-list']/div")) ;
        this.btnUploadImage = element(By.xpath("//button[@name= 'upload-image' or contains(text(),'Upload Image')]"));
        ...
        this.editImageBlockActivity = element(By.xpath(`//p[contains(text(),'Automation_Edit Image')]/../..`));
        ...
        this.continueWithoutSaving = element(By.css("button[name*='Continue']"));
