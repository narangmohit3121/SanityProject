...
export class UserMappingPageLocate{
    ...
    constructor(){
        ...
        this.ch1643_1=element(By.xpath("//button[contains(text(),' Cohort_1643_1 ')]"));
        this.ch1643_2=element(By.xpath("//button[contains(text(),' Cohort_1643_2 ')]"));
        ...
        this.txtSearchUsers=element(By.xpath("//input[@placeholder='Search Users']"));
