...
export class AdminLandingPageLocate {
    ...
    constructor() {
      ...
      //  this.imgMomentaLogo = element(By.xpath("//h3[contains(text(),'Momenta')]"));
        this.imgMomentaLogo = element(By.xpath("//img[@alt='Momenta logo']"));
     //   this.btnHamburgerMenuIcon = element(By.xpath("//button[@class='content__menuicon']"));
        this.btnHamburgerMenuIcon = element(By.xpath("//div[@class='hamburger-inner']"));
        ...
        this.tabClient = element(By.css('[id*="mat-tab-label"]:nth-child(2)'));
      ...
      //  this.tabMasterCollection = element(By.xpath("//span[@class='client-collection__title']"));
        this.tabMasterCollectionTitleAsBTS = element(By.xpath("//h1[contains(text(),'BTS')]"));
