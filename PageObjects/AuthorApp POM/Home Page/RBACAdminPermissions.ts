...
export class RBACLocate {
    ...
    txtfolderpermissionforPetronas: ElementFinder;
    ...
    txtjourneySearch:ElementFinder;
    ...
    constructor() {
        ...
        this.tabclientpermissionpage = element(By.xpath("//mat-tab-group[@class='border-none mat-tab-group mat-primary']//div[contains(text(),'Client')]"));
        this.txtfolderpermissionforPetronas = element(By.xpath("//tr[@class='ng-star-inserted']//td[contains(text(),' petronas ')]"));
        ...
        this.txtjourneySearch=element(By.xpath("//input[@placeholder='Filter Journeys']"));
        ...
        this.tabmastercollection=element(By.xpath("//div[contains(text(),'Master')]"));
        //this.iconplus=element(By.xpath("//i[@class='author-icon icon-plus master-collection__header--plus']"));
