...
export class CreateNewJourneyPageLocate {

  AutomationFolderDONOTDELETEFld:ElementFinder
  AuthorAppFolderFld:ElementFinder
  JourneyFolderFld:ElementFinder
  ThisIsMandatoryForJourneyToastMsg:ElementFinder
    ...
    StageTitleTxt:ElementFinder
    StageSaveBtn:ElementFinder
    ...
    toastMessageSuccesssaveDraftBtn:ElementFinder
    toastMessageSuccesspublishBtn:ElementFinder

    blankJourneyCanvasJrny:ElementFinder;
    addStagePluseIcon:ElementFinder;
    newStageLbl:ElementFinder;
    newModuleLbl:ElementFinder
    ...
    editContentDoneButton: ElementFinder;
    ...
    threedotsOfCreatedJourney:ElementFinder;
    JourneyDeleteOption:ElementFinder;
    JourneyDeleteAlertDeleteBtn:ElementFinder;
    CreateJourney:ElementFinder;
    ...
    constructor() {
        ...
        //Client landing page
        this.AutomationFolderDONOTDELETEFld = element(By.xpath("//p[text()='Automation Folder_DONOT DELETE']"));
        this.AuthorAppFolderFld = element(By.xpath("//p[text()='AuthorApp']"));
        this.JourneyFolderFld = element(By.xpath("//p[text()='Journey']"));
        this.ThisIsMandatoryForJourneyToastMsg = element(By.xpath("//div[@id='toast-container']"));
       ...
       // this.journeyList = element.all(By.xpath("//div[@class='master-collection__cards ng-star-inserted'][1]//child::a"));
        this.journeyList = element.all(By.xpath("//div[@class='master-collection__cards ng-star-inserted']"));
       ...
       // this.qaAutomationJourneyName = element(By.xpath("//p[contains(text(),'QA Journey Petronas')]"))
        ...
        this.momentaJourneySearch = element(By.xpath("//input[@name='search']"));
        this.momentaJourneyPreviewBtn = element(By.buttonText('Preview'));

        //Create New Journey WebElements
        this.createNewJourneyOption = element(By.xpath("//span[.='Create New Journey']"));
        this.createNewJourneyTitle = element(By.xpath("//h3[@class='journey-list__headertext']"));
      //  this.createNewJourneyTitle = element(By.xpath("//input[@id='mat-input-2']"));
        this.CreateJourney = element(By.xpath("//span[text()='Create New Journey']"));
        this.enterJourneyTitle = element(By.xpath("//input[@placeholder='Enter Journey Title']"));
     //   this.enterJourneyTitle = element(By.xpath("//div[@class='mat-form-field-infix']//input[@ng-reflect-model]"));
       ...
       // this.newQaJourneyTitle = element(By.xpath("//span[@class='journey-selection__inno']"))
        this.newQaJourneyTitle = element(By.xpath("//h1[contains(text(),'Journey: Automation QA Journey')]"))
       // this.newQaJourneyDesc = element(By.xpath("//mat-card-subtitle[@class='mat-card-subtitle']"))
        this.newQaJourneyDesc = element(By.xpath("//mat-card-subtitle[@class='journey-selection__journey-description mat-card-subtitle']"))
      
        this.blankJourneyCanvasJrny = element(By.xpath("//p[contains(text(),'This is your canvas....')]"))

        this.addStageButton = element(By.xpath("//button[@name='add stage']"))

        this.StageTitleTxt = element(By.xpath("//input[@name='title']"))
        this.StageSaveBtn = element(By.xpath("//button[contains(text(),'Save')]"))
        this.newStageLbl = element(By.xpath("//h3[@class='journey-selection--font journey-section__fontcolor']"))
        

        this.addModuleButton = element(By.xpath("//button[@name='add module']"))
        this.ModuleTitleTxt = element(By.xpath("//input[@name='title']"))
        this.saveDraftBtn = element(By.xpath("//button[@name='save']"))
        this.publishBtn = element(By.xpath("//button[@name='publish']"))
        this.toastMessageSuccesssaveDraftBtn = element(By.xpath("//div[@class='toast-message ng-star-inserted']"))
        this.toastMessageSuccesspublishBtn = element(By.xpath("//div[@class='toast-message ng-star-inserted']"));
         
        this.newModuleLbl = element(By.xpath("//p[@class='journey-selection__module-title']"))
     


        
        this.addStagePluseIcon = element(By.xpath("//p[contains(text(),'New Stage')]"))
        ...
        this.newModuleMoreIcon = element(By.xpath("(//span[@class='mat-content']//following::mat-panel-description[2]//div[@class='journey-selection__delete'])[1]"))
        ...
        this.newJourneyPreviewButton = element(By.xpath("//button[contains(text(),'PREVIEW')]"))
        this.newJourneyPublishButton = element(By.xpath("//span[contains(text(),'PUBLISH')]"))
        this.newJourneyPreviewPage = element(By.xpath("//h2[.='My Journey']"))
        ...
        this.editContentDoneButton = element(By.xpath("//span[contains(text(),'Done')]"))
        ...
        this.newStageUpdatedTitle = element(By.xpath("//p[@class='journey-selection--font journey-section__fontcolor']"))
        this.newModuleUpdatedTitle = element(By.xpath("//p[contains(text(),'New Module Update')]"))
        ...
        this.threedotsOfCreatedJourney = element(By.xpath("//p[contains(text(),'Automation QA Journey')]//preceding::i[@class='author-icon icon-dots master-collection__icon']"))
        this.JourneyDeleteOption = element(By.xpath("//span[.='Delete']"));
        
        this.JourneyDeleteAlertDeleteBtn = element(By.xpath("//button[@name='Delete']"));
