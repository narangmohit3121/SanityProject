...
Scenario: Verify that Author can edit the discussion thread field & the corresponding changes are reflecting at Participant side
...
Given Participant should login in with "DiscussionAutomation@petronas.com" and "ABab12$"
#When User selects the Sprint 7 module under Automation_Mohit stage
When User clicks on Discussion Thread activity
...
When Participant user logs in with "mohitnarang@petronas.com" and "ABab12$"
#When User selects the Sprint 7 module under Automation_Mohit stage
When User clicks on Discussion Thread activity
