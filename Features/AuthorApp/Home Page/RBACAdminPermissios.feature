Feature: RBAC Admin Permissions
    ...
    @Sprint23
    @RBAC1
    Scenario: Verify if Admin User is able to see 'Manage Permissions' button

        When User clicks on Master tab
        Then User is able to see Manage Permissions button
        When User should click on Client Tab
        Then User is able to see Manage Permissions button

    @Sprint23
    @RBAC2
    Scenario: Verify if Admin User is able to view 'CREATE USER' & 'ADD USER' buttons after clicking on 'MANAGER PERMISSIONS'
