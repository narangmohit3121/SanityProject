...
@CreateImage01
@CreateContent01
Scenario: Verify that user is able to create an activity with Image
...
@CreateGoDo01
@CreateContent01
Scenario: Verify that user is able to create an activity with Go-Do should get created
