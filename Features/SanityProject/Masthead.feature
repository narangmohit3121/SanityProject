...
When User selects the Header Type as Full Screen
When User changes the uploaded image via CHOOSE FILE
When User updates Masthead description
When user clicks on Cancel Edit and saves Draft and then clicks on Exit Editor
Then the edits done to Masthead should not get saved
