...
When('Participant user enter valid Email Id as {string}', async function (string) {
...
When('Participant user enter invalid Email Id as {string}', async function (string) {
  await participantloginpage.participantLoginId.clear().then(async function () {
    await participantloginpage.participantLoginId.sendKeys(string)
...
When('Participant user click on Login Button', async function () {
...
Then('Customer branding page should be displayed with Assigned Journey', async function () {
  ...
  await participantloginpage.JourneyModuleOneName.isPresent().then(async function (result) {
    //  expect(result).to.be.true;
    expect(result).to.be.true;
